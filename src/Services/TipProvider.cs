...
namespace StartScreen.Services
{
    ...
    public sealed class HardCodedTipProvider : ITipProvider
    {
        private static readonly string[] Tips = new[]
        {
            ...
            "Press Ctrl+F12 to find all references to the symbol at the caret.",
            ...
            "Press Alt+F6 to return to the most recent tool window. Press Esc to return focus to the editor.",
            "Press Ctrl+Tab to navigate through open document windows and tool windows.",
            "Press Ctrl+M, G in an MVC controller action method to open the relevant View file.",

            // Editing
            "Press Shift+Alt+C to quickly add a new class to the current folder or project.",
            "Press Ctrl+Enter to insert a new blank line above the current line without moving the caret.",
            "Press Ctrl+R, G to remove and sort using statements in the current file.",
            ...
            "Press Ctrl+R, W to toggle visible whitespace characters in the editor.",
            ...
            "Press Ctrl+Alt+P to split the editor window and view two parts of the same file simultaneously.",
